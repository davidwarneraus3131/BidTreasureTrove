jQuery(function ($) {
	...
	function formErrorSub(){
		$(".newsletter").addClass("animated shake");
		setTimeout(function() {
			$(".newsletter").removeClass("animated shake");
		}, 1000)
	}
	...
	// Count Time 
	function makeTimer() {
		var endTime = new Date("September 20, 2055 17:00:00 PDT");			
...
function setTheme(themeName) {
    localStorage.setItem('eeza_theme', themeName);
