                    ...
                    <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-2 col-md-2">
                                    ...
                                    <img src="../upload/product/<?= $product_image1 ?>" alt="" style="width:150px;height:150px;object-fit:cover;" style="">
                                    <input type="file" name="image"  id="uploadfile" class="form-control">
                                </div>
                                <div class="form-group col-lg-2 col-md-2">
                                    <label for="">image2</label>
                                    <img src="../upload/product/<?= $product_image2 ?>" alt="" style="width:150px;height:150px;object-fit:cover;" style="">
                                    <input type="file" name="image2" id="uploadfile2" class="form-control">
                                </div>
                                <div class="form-group col-lg-2 col-md-2">
                                    <label for="">image3</label>
                                    <img src="../upload/product/<?= $product_image3 ?>" alt="" style="width:150px;height:150px;object-fit:cover;" style="">
                                    <input type="file" name="image3" id="uploadfile3" class="form-control">
                                </div>
                                <div class="form-group col-lg-2 col-md-2">
                                    <label for="">image4</label>
                                    <img src="../upload/product/<?= $product_image4 ?>" alt="" style="width:150px;height:150px;object-fit:cover;" style="">
                                    <input type="file" name="image4" id="uploadfile4" class="form-control">
                                </div>
                                <div class="form-group col-lg-2 col-md-2">
                                    <label for="">video</label>
                                    <img src="../upload/product/<?= $product_image5 ?>" alt="" style="width:150px;height:150px;object-fit:cover;" style="">
...
if (isset($_POST['submit'])) {
    ...
    `product_description`='$product_description',`cut`='$cut',`color`='$color',`clarity`='$clarity',`carat`='$carat',`tax`='$shipping',`brand_name`='$brand_name' WHERE product_id=$id";
