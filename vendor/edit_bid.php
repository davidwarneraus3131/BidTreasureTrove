...
$id = $_GET['edit'];
// echo $id;
$sql = "SELECT * FROM `bid_product_details` WHERE bid_id=$id";
...
<div id="page-wrapper">
                    ...
                    <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="form-group col-lg-2 col-md-2">
                                    ...
                                    <img src="../upload/cards/<?= $product_image1 ?>" alt="" style="width:150px;height:150px;object-fit:cover;" style="">
                                    <input type="file" name="image"  id="uploadfile" class="form-control">
                                </div>
                                <div class="form-group col-lg-2 col-md-2">
                                    <label for="">image2</label>
                                    <img src="../upload/cards/<?= $product_image2 ?>" alt="" style="width:150px;height:150px;object-fit:cover;" style="">
                                    <input type="file" name="image2" id="uploadfile2" class="form-control">
                                </div>
                                <div class="form-group col-lg-2 col-md-2">
                                    <label for="">image3</label>
                                    <img src="../upload/cards/<?= $product_image3 ?>" alt="" style="width:150px;height:150px;object-fit:cover;" style="">
                                    <input type="file" name="image3" id="uploadfile3" class="form-control">
                                </div>
                                <div class="form-group col-lg-2 col-md-2">
                                    <label for="">image4</label>
                                    <img src="../upload/cards/<?= $product_image4 ?>" alt="" style="width:150px;height:150px;object-fit:cover;" style="">
                                    <input type="file" name="image4" id="uploadfile4" class="form-control">
                                </div>
                                <div class="form-group col-lg-2 col-md-2">
                                    <label for="">video</label>
                                    <img src="../upload/cards/<?= $product_image5 ?>" alt="" style="width:150px;height:150px;object-fit:cover;" style="">
                                    <input type="file" name="image5" id="uploadfile5" accept="video/*" class="form-control">
                                </div>
                            </div>
    ...
    <option value="1/4 ct">1/4 ct</option>
        ...
        <!-- Add more fields as needed -->
                        ...
                        <?php if($type=='hot'){ ?>
                        <a href="bid_hot.php?type=hot"><button class="btn btn-blue center-block"><i class="fa fa-backward"
                                    aria-hidden="true"></i>
                                <span>Go Back Top Banner page</span> </button></a><?php } ?>
                        <?php if($type=='upc'){ ?>
                        <a href="bid_hot.php?type=upc"><button class="btn btn-blue center-block"><i class="fa fa-backward"
                                    aria-hidden="true"></i>
                                <span>Go Back Top Banner page</span> </button></a><?php } ?>
                    </div>
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE `bid_product_details` SET `product_name`='$pname',
    ...
    `product_description`='$product_description',`cut`='$cut',`color`='$color',`clarity`='$clarity',`carat`='$carat',`tax`='$shipping',`brand_name`='$brand_name',`hours`='$hours',`min`='$min',`sec`='$sec' WHERE bid_id=$id";
