                        ...
                        <div class="table-responsive">
                            <table id="example-table"
                                ...
                                <tbody>
                                    ...
                                    JOIN `vendor_details` ON `deal_product_details`.`vendor_id`=`vendor_details`.`vendor_id` ORDER BY `deal_product_details`.`vendor_id`";
                                    ...
                                    while ( $row=mysqli_fetch_assoc($res)) { 
                                        ...
                                        <tr>                                            
                                            ...
                                            <td><img src="../upload/deal/<?= $row['product_image1'] ?>" alt="" style="width:110px;height:77px"></td>
                                            <td>
...
$(document).ready(function(){
    $(".user_status").click(function(){
        ...
        if(status==0){
            var alert=confirm("Do you like cancel the deal?");
        }
        else{
            var alert=confirm("Do you  like accept the deal?");
        }
