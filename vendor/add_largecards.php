                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="vendor_id"  value="<?php echo $_SESSION['id'] ?>" class="form-control" required>
                            </div>
...
if (isset($_POST['add_largecards'])) {
    ...
    $sql = "INSERT INTO `largecards`(`image`, `product_name`,`pdf`,`vendor_id`)
     VALUES ('$image1','$product_name','$product_image2','$vendor_id')";
