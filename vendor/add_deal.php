                ...
                <div class="panel panel-default">
                    ...
                    <form method="post" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="vendor_id" value="<?php echo $_SESSION['user_details']['user_id'] ?>"> 
                            </div>
                                <div class="form-group ">
...
if (isset($_POST['add_deal_pro'])){
    ...
    // $sql = "INSERT INTO `deal_product_details`(`product_name`, `product_new_price`, 
    ...
    $sql = "INSERT INTO `deal_product_details` (`product_name`, `product_image1`, `product_image2`, `product_image3`, `product_image4`, `product_image5`, `category_name`, `sub_category_id`, `specification`, `product_description`, `min`,  `type`,`vendor_id`)
    VALUES ('$pname', '$product_image1', '$product_image2', '$product_image3', '$product_image4', '$product_image5', '$category_name', '$sub_category_id','$specification', '$product_description',  '$min', '$type','$vendor_id')
    ";
