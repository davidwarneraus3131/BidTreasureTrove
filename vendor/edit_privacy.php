                            ...
                            <div class="panel-body" id="add_vndr">
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="privacy" value=""
                                        rows="25" cols="50"
                                            id="content" ><?php echo print_r($content) ?></textarea>
                                    </div><br>

                                 
                                    <button type="submit" name="submit" class="btn btn-primary">Update Privacy & Policy</button>
                                </form>
                                <a href="edit_privacy.php"><button class="btn btn-blue center-block"><i
...
if (isset($_POST['submit'])) {
    ...
    $content= $_POST['privacy'];
   



    $sql = "UPDATE `privacy_policy` SET `content`='$content'
    WHERE id=$id";

    $query = mysqli_query($conn, $sql);

    if ($query) {
        echo "<script>alert('Updated Privacy Policy successfully!');</script>";
        echo "<script>window.location.href ='edit_privacy.php'</script>";
    } else {
