                        ...
                        <div class="table-responsive">
                            <table id="example-table"
                                ...
                                <tbody>
                                    ...
                                    JOIN `vendor_details` ON `bid_product_details`.`vendor_id`=`vendor_details`.`vendor_id`JOIN `user_details` ON `bid_product_details`.`user_id`=`user_details`.`user_id` WHERE `bid_product_details`.`vendor_id`='$vendor_id'
                                    ORDER BY `bid_product_details`.`user_id`";
