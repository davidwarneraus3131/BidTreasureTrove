                            ...
                            <table id="example-table"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 78px;"> Buyer Name</th>
                                ...
                                <?php $vendor_id =$_SESSION['id'];?>
                                <tbody>
                                    <?php
                                    $sql = "SELECT * FROM `product_details`
                                    JOIN `vendor_details` ON `product_details`.`vendor_id`=`vendor_details`.`vendor_id`
                                    JOIN `order` ON `product_details`.`product_id`=`order`.`product_id`
                                    JOIN `user_details` ON `product_details`.`user_id`=`user_details`.`user_id` WHERE `product_details`.`vendor_id`='$vendor_id'
                                    ORDER BY `product_details`.`user_id`";
