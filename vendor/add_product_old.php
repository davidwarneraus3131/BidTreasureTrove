        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <li class="active"><input type="radio" name="action" value="bid"> Bid</li>
                      ...
                      <li class="active">  <input type="radio" name="action" value="invest"> Invest</li>
                    ...
                    <div class="panel-body" id="add_prdt" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" name="image2" id="uploadfile2" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="">image3</label>
                                <input type="file" name="image3" id="uploadfile3" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="">image4</label>
                                <input type="file" name="image4" id="uploadfile4" class="form-control" required>
                            </div>
                            <div class="form-group">
                                <label for="">image5</label>
                                <input type="file" name="image5" id="uploadfile5" class="form-control" required>
                            </div>
                            <div class="select-box">
                                <label>category name</label>
                                <select class="form-control" id="getcategory" name="category_name" required></select>
                            </div>
                            <div class="select-box">
                                <label>sub_category name</label>
                                <select class="form-control" id="getsubcategory" name="subcategory_name" required><option style="color:black;" value="">Select SubCategory</option></select>
                            </div>
                            <div class="form-group">
                                <label for="">sku no</label>
                                <input type="text" name="sku_no" class="form-control" required>
                            </div>
                            <div class="form-group">
...
while($row = mysqli_fetch_array($result)) {
?>
<option value=""><?php echo $row["sub_category_name"];?></option>
<?php
}
?>
                                    </select>
