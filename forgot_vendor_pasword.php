                            ...
                            <li class="nav-item">
                                <a href="profile.php" class="nav-link" style="margin-left:-28px;">
                                    <?php if (isset($_SESSION['vendor_details'])) { ?>
                                        <img src="upload/profile/<?php echo $_SESSION['vendor_details']['user_img'] ?>" class="sc-himrzO kCyZje rounded-circle" style="width: 30px;
...
<?php 
    if(isset($_POST["recover"])){
        ...
        $sql = mysqli_query($db, "SELECT * FROM vendor_details WHERE email='$email'");
        ...
        if(mysqli_num_rows($sql) <= 0){
            ...
            $mail->Body="<p>Dear Vendor, </p> <h3>Your verify OTP code is $otp <br></h3>
            <br><br>
            <p>With regrads,</p>
            ...
            if(!$mail->send()){
                ...
                <script>
                    ...
                    window.location.replace('verification_vendor.php');
                </script>
                <?php
            }
        }
