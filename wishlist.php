          ...
          <div class="tab-pane mb-3" id="account-orders">
                ...
                <table class=" table  table-hover shop-table account-orders-table mb-6">
                  ...
                  <tbody class="table-hover fetch_orderdatas" style="text-align: center;">
                             ...
                             ON wishlist.product_id = product_details.product_id
                                   ...
                                   while($row=mysqli_fetch_assoc($result)){
                                      ...
                                      //  $status=$row['status'];
                                       ...
                                       <tr>
                                        ...
                                        <td style="padding-right: 164px;"><img style="width:100px; height:86px;object-fit: cover" src="./upload/product/<?php echo $product_img; ?>" alt="product_images"></td>
                                        ...
                                        <td style="padding-right: 108px;">  <a href="javascript:void();" id="<?php echo $product_id;?>" name="add"  style="cursor:pointer" class="add_to_cart add<?php echo $product_id;?> primary-btn button">Add To Cart</a></td>
                                       </tr>
                                       <?php } ?>
                  </tbody>
                </table>
