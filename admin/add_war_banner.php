...
<div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="page-title">
                    <h1>Add Bannerimage</h1>
                    <ol class="breadcrumb">
                        <li><i class="fa fa-dashboard"></i> <a href="index.php">Dashboard</a>
                        </li>
                        <li class="active">War House</li>
                    </ol>
                </div>
            </div>
            <!-- /.col-lg-12 -->
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" >
                        <form method="post" enctype="multipart/form-data" action="">
                            ...
                            <div class="form-group">
                                <button class="btn btn-primary" type="submit" name="add_banner" value="submit">Submit</button>
                            </div>
                        </form>
    ...
    if($image1!=""){
        ...
        $sql="INSERT INTO `war_banner`(`background_image`, `title`) VALUES ('$image1','$text')";
