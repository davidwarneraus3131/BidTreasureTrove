                ...
                <div class="portlet portlet-default">
                    <div class="portlet-heading">
                        <div class="portlet-title" style="width: 100%; height: 40px;">
                            <h4>cards list<a href="add_save_cards.php" id="add_new_service" class="btn btn-green btn-sm" style="float:right; margin-top:-7px;"><i class="fa fa-plus"></i> Add New cards </a></h4>
                        </div>
                            ...
                            <table id="example-table" class="table table-striped table-bordered table-hover table-green">
                                ...
                                //  print_r($result);
                                     ...
                                     while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                              <td><?= $id?></td>
                                            <td><img src="../upload/save_cards/<?= $img ?>" alt="" style="width:150px;height:150px;object-fit:cover;"></td>
                                            <td><?= $heading?></td>
                                           
                                           
                                           
                                            <td style="display:flex;justify-content:space-between;">
                                                    <a href="edit_save_cards.php?edit='<?= $id ?>'"><i class="fa fa-edit btn btn-primary"></i></a>
                                                    <a  onclick="confirm('Are you sure want to delete?')"href="delete_save_cards.php?deleteid='<?=$id ?>'"><i class="fa fa-trash-o btn btn-danger"></i></a>
                                             </td>
                                        </tr>
                                  <?php
                                     }?>
