...
$sql1="SELECT * FROM `war_banner` WHERE id=$id";
...
<div id="page-wrapper">
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" >
                        ...
                        <form method="post" enctype="multipart/form-data" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group col-lg-2 col-md-3">
                                        ...
                                        <img src="../upload/war_banner/<?=$image1?>" style="width:150px;height:150px;object-fit:cover;" alt="">
                        ...
                        <a href="war_banner.php"><button class="btn btn-blue center-block"><i class="fa fa-backward" aria-hidden="true"></i>
    ...
    if($image1!=""){
        ...
        $targetDir = "../upload/war_banner/";
        $target_image1 = $targetDir . basename($image1);
        move_uploaded_file($_FILES['image']['tmp_name'], $target_image1);
        }else{
            $product_image1="";
        }
        $sql="UPDATE `war_banner` SET `background_image`='$image1',
        `title`='$title' WHERE id=$id";
          $res=mysqli_query($conn,$sql);

          if($res){
            echo "<script>alert('updated banner  successfully');</script>";
