...
include_once 'objects/subcategory_obj.php';
...
$user->sub_category_id = $_POST['sub_category_id'];
...
$fileExt = end($kaboom);
        ...
        $moveResult = move_uploaded_file($fileTmpLoc, "../../upload/subcategory/$fileName");
        if($moveResult!= true)
        {
             $fileName = $file;
        } 
