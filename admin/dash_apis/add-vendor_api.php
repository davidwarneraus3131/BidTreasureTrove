...
$fileTmpLoc2 = $_FILES["pan_photo"]["tmp_name"]; 
$fileType2 = $_FILES["pan_photo"]["type"];
$fileSize2 = $_FILES["pan_photo"]["size"];
$fileErrorMsg2 = $_FILES["pan_photo"]["error"];
...
$user->pan_photo = $fileName2;

$fileName3 = $_FILES["aadharimage1"]["name"]; 									
$fileTmpLoc3 = $_FILES["aadharimage1"]["tmp_name"]; 
$fileType3 = $_FILES["aadharimage1"]["type"];
$fileSize3 = $_FILES["aadharimage1"]["size"];
$fileErrorMsg3 = $_FILES["aadharimage1"]["error"];
...
$user->aadharimage1 = $fileName3;

$fileName4 = $_FILES["aadharimage2"]["name"]; 									
$fileTmpLoc4 = $_FILES["aadharimage2"]["tmp_name"]; 
$fileType4 = $_FILES["aadharimage2"]["type"];
$fileSize4 = $_FILES["aadharimage2"]["size"];
$fileErrorMsg4 = $_FILES["aadharimage2"]["error"];
...
$user->aadharimage2 = $fileName4;

$fileName5 = $_FILES["gst_img"]["name"]; 									
$fileTmpLoc5 = $_FILES["gst_img"]["tmp_name"]; 
$fileType5 = $_FILES["gst_img"]["type"];
$fileSize5 = $_FILES["gst_img"]["size"];
$fileErrorMsg5 = $_FILES["gst_img"]["error"];
