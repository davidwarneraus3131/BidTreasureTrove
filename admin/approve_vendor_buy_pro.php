...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
   ...
   echo $sql = "UPDATE `product_details` SET status = 'approved' WHERE product_id = $product_id";
    if ($conn->query($sql) === TRUE) {
        ...
        $message = "Dear Vendor,Your product '{$product_name}' has been Approved.With Regards,Treasure Trove";
