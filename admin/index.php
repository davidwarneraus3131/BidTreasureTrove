...
//total  bid products
$Totalbidproduct = "SELECT * FROM `bid_product_details` ";
...
//total  deal products
$Totaldealproduct = "SELECT * FROM `deal_product_details` ";
                ...
                <div class="circle-tile">
                    <a href="deal.php?type=hot">
                     ...
                     <div class="circle-tile-content dark-blue">
                        ...
                        <div class="circle-tile-number text-faded">
                            <?php echo $Totaldealproducts?>

                            <span id="sparklineB"></span>
                        </div>
                        <a href="deal.php?type=hot" class="circle-tile-footer">More Info <i class="fa fa-chevron-circle-right"></i></a>
                    </div> 
                </div>
            </div>
            <div class="col-lg-2 col-sm-6">
