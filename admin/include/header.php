                ...
                <ul id="side" class="nav navbar-nav side-nav">
                    ...
                    <li class="panel">
                        ...
                        <ul class="collapse nav" id="cs">
                            ...
                            <!-- <a  href="javascript:;" data-parent="#sid" data-toggle="collapse" class="accordion-toggle"
                            data-target="#invest">
                                     Upload invest Products<i class="fa fa-caret-down"></i>
                                </a>
                                <ul class="collapse nav" id="invest">
                                <li>
                                <a href="slider.php?type=hot">
                                    <i class="fa fa-angle-double-right"></i>Hot invest
                                </a>
                            </li>
                                <li>
                                <a href="invest_upcoming.php?type=upc">
                                    <i class="fa fa-angle-double-right"></i>Upcoming invest Products
                                </a>
                            </li>
                            </ul>
                            </li> -->
                ...
                <li>
                    ...
                    <li class="panel">
                        ...
                        <a class="" href="Vendors.php">
                            <i class="fa fa-user"></i>Vendors Report
                        </a>
                    </li>
                    <!-- <li>
                    ...
                    <li>
                        <a class="" href="donation.php">
                            <i class="fa fa-list-alt"></i>Donation Reports
                        </a>
                    </li>
                    <!-- <li>
                        <a class="" href="Payments.php">
