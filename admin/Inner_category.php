                ...
                <div class="portlet portlet-default">
                    <div class="portlet-heading">
                        <div class="portlet-title" style="width: 100%; height: 40px;">
                            <h4>Service List <a href="add_sub.php" class="btn btn-green btn-sm" style="float:right; margin-top:-7px;"><i class="fa fa-plus"></i> Add New deal Products</a></h4>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table id="example-table" class="table table-striped table-bordered table-hover table-green">
                                ...
                                <?php
                                 ...
                                 $sql = "SELECT * FROM `inner_sub_category`";
                              
                                 $result = mysqli_query($conn, $sql);
                                //  print_r($result);
                             
                                     while ($row = mysqli_fetch_assoc($result)) {
                                        $id=$row['in_sub_category_id'];
                                       $sub_cat_img=$row['in_subcategoty_image'];
                                       $sub_cat_name=$row['in_sub_category_name'];
                                        ...
                                        <tr>
                                              ...
                                              <td><?= $sub_name?></td>
                                              <td><?= $sub_cat_name?></td>
                                            <td><img src="../upload/inner_cat/<?=  $sub_cat_img ?>" alt="" style="width:150px;height:150px"></td>
                                            
                                          
                                           
                                            <td></td>
                                            <td style="display:flex;justify-content:space-between;">
                                                    <a href="edit_sub.php?edit='<?= $id ?>'"><i class="fa fa-edit btn btn-primary"></i></a>
                                                    <a href="delete_sub.php?deleteid='<?=$id ?>'"><i class="fa fa-trash-o btn btn-danger"></i></a>
                                             </td>
                                        </tr>
