...
$sql1="SELECT * FROM `save_cards` WHERE id=$id";
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body" >
                        ...
                        <form method="post" enctype="multipart/form-data" action="">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group col-lg-2 col-md-3">
                                        ...
                                        <img src="../upload/save_cards/<?=$image1?>" style="width:150px;height:150px;object-fit:cover;" alt="">
                        ...
                        <a href="save_cards.php"><button class="btn btn-blue center-block"><i class="fa fa-backward" aria-hidden="true"></i>
