                ...
                <div class="portlet portlet-default">
                    <div class="portlet-heading">
                        <div class="portlet-title" style="width: 100%; height: 40px;">
                            <h4>Activity list<a href="add_save_activities.php" id="add_new_service" class="btn btn-green btn-sm" style="float:right; margin-top:-7px;"><i class="fa fa-plus"></i> Add Activity </a></h4>
                        </div>
                    ...
                    <div class="portlet-body" id="slide_page_show">
                        <div class="table-responsive">
                            <table id="example-table" class="table table-striped table-bordered table-hover table-green">
                                ...
                                <tbody>
                                    <?php
                                $sql = "SELECT * FROM `save_activities`";
                                ...
                                //  print_r($result);
                                     ...
                                     while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                              <td><?= $id?></td>
                                            <td><img src="../upload/save_activities/<?= $img ?>" alt="" style="width:150px;height:150px;object-fit:cover"></td>
                                            <td><?= $heading?></td>
                                           
                                           
                                           
                                            <td style="display:flex;justify-content:space-between;">
                                                    <a href="edit_save_activities.php?edit='<?= $id ?>'"><i class="fa fa-edit btn btn-primary"></i></a>
                                                    <a  onclick="confirm('Are you sure want to delete?')"href="delete_save_activities.php?deleteid='<?=$id ?>'"><i class="fa fa-trash-o btn btn-danger"></i></a>
                                             </td>
                                        </tr>
                                  <?php
                                     }?>
