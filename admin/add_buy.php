...
<div id="page-wrapper">
    ...
    <input type="text" name="description"    autocomplete="on" class="form-control">
...
function showSuggestions(keyword) {
    if (keyword.length === 0) {
        ...
        fetch("get_suggestions.php?keyword=" + keyword)
            ...
            .then(data => {
                ...
                data.forEach(item => {
                    ...
                    li.onclick = function() {
                        document.getElementById("search").value = item.keyword;
