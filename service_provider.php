                ...
                <div class="profile-authentication-tabs">
                    <div class="authentication-tabs-list">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                            <a class="nav-link"  href="forgot_s_provider_pasword.php" role="tab" >Reset Password</a>                            </li>
                            </li>
                        </ul>
                    </div>
                    <!-- login page -->
                        ...
                        <div class="tab-pane fade show active" id="register" role="tabpanel">
                            ...
                            if (isset($_POST['register'])) {
                                ...
                                if ($emailCount > 0) {
                                    ...
                                    $sql = "INSERT INTO `service_provider`(`s_name`, `s_number`, `s_email`, `password`, `cpassword`, `dob`, `ssn_no`, `country`, `state`, `city`, `zipcode`, `user_img`,`pan`) VALUES ('$firstname','$mobile','$email','$password','$cpassword',' $dob ','$ssn','$country','$state','$city','$zipcode','$image','$pan_card_img')";
                                    $result = $db->query($sql);
                                    if ($result == TRUE) {
