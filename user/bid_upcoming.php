                                ...
                                //  print_r($result);
                                     ...
                                     while ($row = mysqli_fetch_assoc($result)) {
                                       ...
                                       $product_old_price=$row['product_old_price'];
                                        ...
                                        ?>
                                        <tr>
                                            <td><img src="../upload/cards/<?= $product_img ?>" alt="" style="width:150px;height:150px"></td>
                                            <td><?= $product_name?></td>
                                            <td><?= $category?></td>
                    ...
                    <div class="portlet-body" id="card_hide" style="display: none;">
                        <div class="table-responsive">
                            ...
                            <div class="form-group">
                                ...
                                <a href="bid_upc.php"><button class="btn btn-blue center-block"><i class="fa fa-backward" aria-hidden="true"></i>
