  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $.each(data, function (key, value) {
        html += "<tr>";
        html +=
          "<td><img style='width:40px;' src='../upload/largecards/" +
          value.image +
          "'></td>";
        html += "<td>" + value.product_name + "</td>";
        ...
        html +=
          "<td style='display:flex;justify-content: space-around;padding: 16px;';><i class='edit-largecards fa fa-edit btn btn-primary' data-eid='" +
          value.largecards_id +
          "'></i> <i class='delete-largecard fa fa-trash-o btn btn-danger' data-id='" +
          value.largecards_id +
          "'></i></td>";
        html += "</tr>";
      });
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      $.each(data, function (key, value) {
        ...
        html +="<td>";
        if(value.status==1){
          html+= "<button class='btn btn-success ven_status' data-venId='"+value.vendor_id+"' data-status='0'>Active</button>";
        }else if(value.status==0){
          html+= "<button class='btn btn-danger ven_status' data-venId='"+value.vendor_id+"' data-status='1'>Deactive</button>";
        }
          html+="</td>";
        html +=
