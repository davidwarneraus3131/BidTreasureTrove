...
<head>
    ...
    <title>Treasure Troove User Dashboard</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <div class="navbar-brand">
                    <a href="index.php">
                        <b style="color:white;">Treasure Troove</b>
                    </a>
                </div>
            </div>
            <!-- end BRAND HEADING -->
        ...
        <!-- <?php print_r($_SESSION['user_details']); ?>  -->
            <div class="navbar-collapse sidebar-collapse collapse">
                <ul id="side" class="nav navbar-nav side-nav">
                    ...
                    <li class="side-user hidden-xs">
                        <img class="img-circle" width="100px" height="100px" style="margin-left: 46px;" src="../upload/profile/<?php echo $_SESSION['user_details']['user_img'] ?> " alt="">
                        <p class="welcome">
                            <i class="fa fa-key"></i> Logged in as
                        </p>
                        <p class="name tooltip-sidebar-logout">
                            <?php echo $_SESSION['user_details']['user_name'] ?>  <span class="last-name"></span> <a
                    ...
                    <li class="panel">
                        <a href="javascript:;" data-parent="#side" data-toggle="collapse" class="accordion-toggle"
                            data-target="#cs">
                            <i class="fa fa-shopping-cart"></i>User Upload<i class="fa fa-caret-down"></i>
                        </a>
            ...
            <li>
                                <a href="accepted_deals.php">
                                    <i class="fa fa-angle-double-right"></i>Accepted Deals
                                </a>
                            </li>
