                                    ...
                                    <div class="tab-pane fade in active" id="overview">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-4">
                                                ...
                                                <p><i class="fa fa-globe fa-muted fa-fw"></i>  <a href="#">https://www.website.com</a>
                                                </p>
                                                    ...
                                                    <div class="tab-pane fade in active" id="basicInformation">
                                                        <form role="form">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="url" class="form-control" value="https://www.website.com/">
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <input type="url" class="form-control" value="https://www.facebook.com/john.smith9324">
                                                            </div>
                                                            <div class="form-group">
                                                                <label><i class="fa fa-linkedin fa-fw"></i> LinkedIn Profile URL</label>
                                                                <input type="url" class="form-control" value="https://www.linkedin.com/u/john.smith923">
                                                            </div>
                                                            <div class="form-group">
                                                                <label><i class="fa fa-google-plus fa-fw"></i> Google+ Profile URL</label>
                                                                <input type="url" class="form-control" value="https://plus.google.com/john-smith9993">
                                                            </div>
                                                            <div class="form-group">
