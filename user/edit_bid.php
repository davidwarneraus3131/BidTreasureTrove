                    ...
                    <form method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-lg-2 col-md-2">
                                    ...
                                    <img src="../upload/cards/<?= $product_image2 ?>" alt="" style="width:150px;height:150px" style="">
                                    <input type="file" name="image2" id="uploadfile2" class="form-control">
                                </div>
                                <div class="form-group col-lg-2 col-md-2">
                                    <label for="">image3</label>
                                    <img src="../upload/cards/<?= $product_image3 ?>" alt="" style="width:150px;height:150px" style="">
                                    <input type="file" name="image3" id="uploadfile3" class="form-control">
                                </div>
                                <div class="form-group col-lg-2 col-md-2">
                                    <label for="">image4</label>
                                    <img src="../upload/cards/<?= $product_image4 ?>" alt="" style="width:150px;height:150px" style="">
                                    <input type="file" name="image4" id="uploadfile4" class="form-control">
                                </div>
                                <div class="form-group col-lg-2 col-md-2">
                                    <label for="">image5</label>
                                    <img src="../upload/cards/<?= $product_image5 ?>" alt="" style="width:150px;height:150px" style="">
...
if (isset($_POST['submit'])) {
    ...
    `product_description`='$product_description',`shipping`='$shipping',`brand_name`='$brand_name',`hours`='$hours',`min`='$min',`sec`='$sec' WHERE bid_id=$id";
