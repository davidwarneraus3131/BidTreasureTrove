                    ...
                    <div class="portlet-body" id="card_show">
                        <div class="table-responsive">
                            <table id="example-table" class="table table-striped table-bordered table-hover table-green">
                                ...
                                <tbody>
                                <?php  $admin_id=$_SESSION['user_details']['user_id']?>
                                <?php


                                  
                                    $upc=$_GET['type'];
                                 $sql = "SELECT * FROM `deal_product_details` WHERE `type`='$upc' AND `vendor_id`='$admin_id'";
                                    ...
                                    //    $product_image5=$row['product_image5'];
                                        ...
                                        <tr>
                                            ...
                                            <td style="display:flex;justify-content:space-between;">
                                             ...
                                             <td><a class="btn btn-sm btn-success" href="deal_report.php?deal_for_id=<?=$id?>">View Dealings</a></td>
                                        </tr>
