...
$upc=$_GET['type'];
                                 ...
                                 $sql = "SELECT * FROM `product_details` WHERE `type`='$upc'";
                                  }
                                  if($_SESSION['type']=='vendor'){ 
                                 $sql = "SELECT * FROM `product_details` WHERE `type`='$upc' AND `vendor_id`='$admin_id'";
                                  }                            
                                ...
                                //  print_r($result);
                                     ...
                                     while ($row = mysqli_fetch_assoc($result)) {
                                       ...
                                       $product_old_price=$row['product_old_price'];
                                          ...
                                          ?>
                                        <tr>
                                            <td><img src="../upload/product/<?= $product_img ?>" alt="" style="width:150px;height:150px"></td>
                                            <td><?= $product_name?></td>
                                            <!-- <td><?= $category?></td> -->
