...
<div class="product-con">
    ...
    <section id="products" class="pro-con">
        <div class="list-pro">
            ...
            $sql="SELECT * FROM `product_details` WHERE `sub_category_id`='$sc_id' AND `status` = 'approved' AND `balanced_stock`!=0";
                        ...
                        <div class="product-content">
                            ...
                            <div class="product-detail">
                                ...
                                <?php 
                                 ...
                                 <li>Available: <span><b class="stock"></b></span></li>
                                 <li>Category: <span><b><?php echo $category_name; ?></b></span></li>
...
$.ajax({
    ...
    success: function(data){
        ...
        $new_category = $(".category").text(rec.category_name);
