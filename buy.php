...
<div class="product-con">
                            ...
                            <div id="accordion_b001" class="accordion-collapse collapse show"
                                ...
                                <div class="accordion-body pt-1">
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li><a href="most_buy.php">Most Buy</a></li>
    ...
    <section id="products" class="pro-con">
        <div class="list-pro">
                ...
                <i>
                    <div class="abs"><a
                            href="add_wishlist.php?product_id=<?php echo $product_id ?>&user_id=<?php echo $user_id ?>"><i
                                class="fa fa-heart" title="add to your Wishlist"
            ...
            <div class="card-img-top" data-proId="<?php echo $product_id ?>"> <img
                    style="width:188px;height:190px;object-fit:cover; border-radius: 15px 15px 0 0;"
                    class="card-img-top-b" src="./upload/product/<?php echo $product_image1; ?>" alt="Card image cap">
            </div>
            ...
            <div class="card-body">
                ...
                <p class="card-text"><b
                        style="text-decoration: line-through;opacity:0.9;font-size:13px;"><?php echo $currency_symbol ?><?php echo $product_old_price; ?></b><b><?php echo  $currency_symbol ?><?php echo $convert_price ?></b>
                </p>
                ...
                <button class="btn  btn-lg btn_grad_blgr  text-truncate mt-auto"> <a href="#"
                        ...
                        class="add_to_cart add<?php echo $product_id; ?> primary-btn button">ADD TO CART</a></button>
            </div>
        </div>
        <?php } ?>
                    ...
                    <div class="one">
                        <div class="product-imgs">
                            <div class="img-display">
                                <div class="img-showcase">
                                    ...
                                    <img style="width:300px;height:396px;object-fit:cover" src="" class="childThree"
                                        alt="product image">

                                    <video width="500px" height="396px" style="display:grid;place-items:center;"
                                        class="childFour videoClass" controls>
                        ...
                        <div class="product-content">
                            ...
                            <form action="submit_rating.php" method="POST">
                                ...
                                <!-- submit rate ths product -->
                                <br>
                                <button class="btn btn-primary" type="submit" value="Submit Rating"
                                    name="submit_rating">Submit</button>
                            </form>
    ...
    $(".card-img-top").click(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $("#product_id_input").val(rec.product_id);
