                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent" style="margin-right:0px;">
                        <ul class="navbar-nav m-auto" style="margin-right: 20px;">
                            ...
                            <?php if (isset($_SESSION['vendor_details']) == FALSE) { ?>
                                <!-- <li class="nav-item">
    ...
    if(isset($_POST["submit"])){
        ...
        if(empty($newPass) && empty($cpass)){
           ...
           <?php
            ...
            mysqli_query($db, "UPDATE vendor_details SET `password`='$newPass', `cpassword`='$cpass' WHERE email = '$email'");
            ?>
             <script>
                 alert("New Password Created Successfully");
                   window.location.replace("vendor_register.php");
             </script>
             <?php
        }
