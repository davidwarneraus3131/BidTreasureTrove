                ...
                <ul class="navbar-nav m-auto" style="margin-right: 40px;">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="nav-item">
                                <a href="cart.html" class="nav-link">Mens Wear</a>
                            </li>

                            <li class="nav-item">
                                <a href="checkout.html" class="nav-link">Womens Wear</a>
                            </li>

                            <li class="nav-item">
                                <a href="my-account.html" class="nav-link">kids</a>
                            </li>
                            <li class="nav-item">
                                <a href="my-account.html" class="nav-link">Home Appliances</a>
                            </li>
                            <li class="nav-item">
                                <a href="my-account.html" class="nav-link">Beauty & Health</a>
                            </li>
                            <li class="nav-item">
                                <a href="my-account.html" class="nav-link">Babies & Moms</a>
                            </li>
                            <li class="nav-item">
                                <a href="my-account.html" class="nav-link">Phones & Accessories</a>
                            </li>
                            <li class="nav-item">
                                <a href="my-account.html" class="nav-link">Jewelry</a>
                            </li>
                            <li class="nav-item">
                                <a href="my-account.html" class="nav-link">Computer & Technology</a>
                            </li>
                            <li class="nav-item">
                                <a href="my-account.html" class="nav-link">Electronics</a>
                            </li>
                            <li class="nav-item">
                                <a href="my-account.html" class="nav-link">Realestate</a>
                            </li>
                            <li class="nav-item">
                                <a href="my-account.html" class="nav-link">Vehicles</a>
                            </li>
                       </ul> 
                    </li>
        ...
        <div class="col-lg-3 col-sm-4 col-11 offset-sm-0 offset-1">
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <a href="#" class="btn btn-warning btn-lg btn_grad_blgr w-50 text-truncate mt-auto" >Bid $250</a>
