...
if (isset($_SESSION['user_details'])) {
    ...
    $vendor_id = $_SESSION['s_provider']['user_id'];
}
                                ...
                                <li class="nav-item">
                                    <a href="profile.php" class="nav-link" style="margin-left:-28px;display:flex;">
                                        <?php if (isset($_SESSION['user_details'])) { ?>
                                            <img src="upload/profile/<?php echo $_SESSION['user_details']['user_img'] ?>" class="sc-himrzO kCyZje rounded-circle" style="width: 30px;height: 30px;border:none;">
                                        <?php    } else if (isset($_SESSION['vendor_details'])) { ?>
                                            <img src="upload/vendors/<?php echo $_SESSION['vendor_details']['vendor_image'] ?>" class="sc-himrzO kCyZje rounded-circle" style="width: 25px;height: 25px;">
                                        <?php  }  else if (isset($_SESSION['s_provider'])) { ?>
                                            <img src="upload/s_provider/<?php echo $_SESSION['s_provider']['user_img'] ?>" class="sc-himrzO kCyZje rounded-circle" style="width: 25px;height: 25px;">
                                        <?php  } 
                                        else {
                                            echo 'img';
                                        } ?> My Account </a>
                    ...
                    <img src="assets/images/facebook.png" alt="">
                        ...
                        <div class="col-lg-2">
                            <div class="header__cart">
                                <ul>
                                    <li><a href="cart.php"><i class="fa fa-shopping-cart"></i> <span class="fetch_cart_count"   id="cart_style"style="background-color:#01acfe;margin-top:-10px;">0</span></a>
                                    </li>
                                </ul>                            
                            </div>
                        </div>
