...
function loadAllCart(){ 
 ...
 function loadAllCartCount() {
  ...
  // Retrieve the values of fetch_cart_value and fetch_cart_value_tax
  var cartValue = parseFloat($(".fetch_cart_value").html());
  var cartValueTax = parseFloat($(".fetch_cart_value_tax").html());

  // Calculate and set cart total (sum of cart value and tax)
  $(".fetch_cart_total").html(cartValue + cartValueTax);
