                ...
                <nav class="navbar navbar-expand-md navbar-light">
                    ...
                    <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent" style="margin-right:0px;">
                        <ul class="navbar-nav m-auto" style="margin-right: 20px;">
                            ...
                            <?php if (isset($_SESSION['service_provider']) == FALSE) { ?>
                                <!-- <li class="nav-item">
    ...
    if(isset($_POST["submit"])){
        ...
        if(empty($newPass) && empty($cpass)){
           ...
           <?php
            ...
            mysqli_query($db, "UPDATE service_provider SET `password`='$newPass', `cpassword`='$cpass' WHERE s_email = '$email'");
            ?>
             <script>
                 alert("New Password Created Successfully");
                   window.location.replace("service_provider.php");
             </script>
             <?php
        }
