...
<div class="container" style="justify-content:stretch;">
    ...
    <div class="div">
        <h5 onclick="show()" style="margin-top:1px;"> <img title="Filter" src="assets/images/products/filter.png"
                alt="Filter" style="width: 20px;
    height: 22px;
...
for search results */
            ...
            <div class="product-con">
                <nav id="menuu">
                    <section class="containers" id="showw"
                        style="display: none;height:450px; overflow-y: scroll;width:70%;" onclick="expand()">
                        <div class="rows">
                                            ...
                                            <div id="accordion_b001" class="accordion-collapse collapse show"
                                                ...
                                                <div class="accordion-body pt-1">
                                                    ...
                                                    <div class="row row-cols-md-2 g-2 mb-3">
                                                        <div class="col">
                                                            <label>Min</label>
                                                            <input class="form-control px-1" name="min_price"
                                                                id="min_price" placeholder="0" type="number" />
                                                        </div>
                                                        <div class="col text-end">
                                                            <label>Max</label>
                                                            <input class="form-control px-1" name="max_price"
                                                                id="max_price" placeholder="10000" type="number" />
                                                        </div>
                                                    </div>
...
$user_currency_type=$user_details['cur_type'];
            ...
            ?>
                        <div class="card" id="pro<?php echo $bid_id;?>">
                            ...
                            <img class="card-img-top" style="object-fit:cover;" data-bidId="<?php echo $bid_id ?>"
                                src="./upload/cards/<?php echo $bid_image; ?>" alt="Card image cap">
                            <!-- The Modal -->
                            <div class="card-body">
                    ...
                    ?>
                                ...
                                const timerElement<?php echo $bid_id;?> = document.getElementById(
                                    "timer<?php echo $bid_id;?>");
                                // Start the timer
                                ...
                                <button id="bidbtn<?php echo $bid_id;?>"
                                    ...
                                    <button id="bidbtn<?php echo $bid_id;?>"
                                        ...
                                        <button id="bidbtn<?php echo $bid_id;?>"
                                            ...
                                            data-bid_amo='<?php echo $bid_inc_price;?>'
                                            data-bidId='<?php echo $bid_id ?>'>
                                            <?php  }
   else{?>
                                            <button id="bidbtn<?php echo $bid_id;?>"
                                                class="btn  btn-lg btn_grad_blgr w-50 text-truncate mt-auto increase"
                                            ...
                                            <span class="sc-ciZhAO bpCaOA d-inline-block"
                                                style="margin-bottom:3px;display:grid;place-items:center;">winning<img
                                                    ...
                                                    class="sc-jdAMXn bbLgnY"><?php echo $user_name?><svg
                                                        xmlns="http://www.w3.org/2000/svg" height="13"
                                                        viewBox="0 0 512 341.337">
                                                        <g transform="translate(0 -85.331)">
                                                            <rect width="512" height="341.337"
                                                                transform="translate(0 85.331)" fill="#f0f0f0"></rect>
                                                            <g>
                                                                <rect width="512" height="42.663"
                                                                    transform="translate(0 127.994)" fill="#d80027">
                                                                </rect>
                                                                <rect width="512" height="42.663"
                                                                    transform="translate(0 213.331)" fill="#d80027">
                                                                </rect>
                                                                <rect width="512" height="42.663"
                                                                    transform="translate(0 298.657)" fill="#d80027">
                                                                </rect>
                                                                <rect width="512" height="42.663"
                                                                    transform="translate(0 383.994)" fill="#d80027">
                                                                </rect>
                                                            </g>
                                                            <rect width="256" height="183.797"
                                                                transform="translate(0 85.331)" fill="#2e52b2"></rect>
                                                            <g>
                                                                <path
                                            ...
                                            <div><span class="sc-bBXxYQ cIskxF"><b
                                                        style="color:#323030;font-size:13px;">Sold
                                                        By:</b></span><a style="padding-left:1px;"
                            ...
                            <div class="img-display">
                                <div class="img-showcase">
                                    ...
                                    <img style="width:300px;height:396px;" src="" class="childThree"
                                        alt="product image">
                                    <video width="500px" height="396px" style="display:grid;place-items:center;"
                                        class="childFour" controls>
