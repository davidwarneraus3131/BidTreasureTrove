                        ...
                        <ul class="navbar-nav m-auto" style="margin-right: 20px;">
                            ...
                            <li class="nav-item">
                                <a href="profile.php" class="nav-link" style="margin-left:-28px;">
                                    <?php if (isset($_SESSION['service_provider'])) { ?>
                                        <img src="upload/profile/<?php echo $_SESSION['service_provider']['user_img'] ?>" class="sc-himrzO kCyZje rounded-circle" style="width: 30px;
    height: 30px;border:none;
">
                                    <?php    } else if (isset($_SESSION['service_provider'])) { ?>
                                        <img src="upload/vendors/<?php echo $_SESSION['service_provider']['vendor_image'] ?>" class="sc-himrzO kCyZje rounded-circle" style="width: 25px;
   height: 25px;
">
...
">
    ...
    <body>
        ...
        <h3 class="text-center" style="margin-top:29px;font-weight:500" >Forgot Password</h3>
                        ...
                        <div class="tab-pane fade show active" id="register" role="tabpanel">
                            <div class="eeza-authentication-form">
                                ...
                                <div class="form-group">
                                        <input type="text" class="form-control" id="s_email" name="email" placeholder="Email">
                                    </div>
                                    
                                    
                                    <button type="submit" name="recover" id="recover" value="Recover" class="default-btn">Get OTP<i class="flaticon-send"></i></button>
...
<?php 
    if(isset($_POST["recover"])){
        ...
        $sql = mysqli_query($db, "SELECT * FROM service_provider WHERE s_email='$email'");
        ...
        if(mysqli_num_rows($sql) <= 0){
            ...
            $mail->Body="<p> Dear Service Provider, </p> <h3>Your verify OTP code is $otp <br></h3>
            <br><br>
            <p>With regrads,</p>
            <b>BidTreasureTrove</b>
            ";
            // $mail->send();
            if(!$mail->send()){
                ?>
                ...
                <script>
                    ...
                    window.location.replace('verification_s_provider.php');
                </script>
                <?php
            }
        }
