...
<nav class="navbar navbar-expand-sm navbar-light bg-white border-bottom">
    ...
    <div class="collapse navbar-collapse" id="navbarColor">
        <ul class="navbar-nav">
            ...
            <li class="nav-item "><a class="nav-link" style="font-size: 50px; padding-left: 9.5rem; color: black;">Vehicles</a> </li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div class="w3-container">
                    ...
                    <button onclick="document.getElementById('id01').style.display='block'" class="w3-button w3-black">Add to cart</button>
