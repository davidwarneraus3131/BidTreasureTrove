...
<head>
                    ...
                    <ul class="topbar-action">
                        ...
                        <li class="dropdown language-option">
                            ...
                            <div class="dropdown-menu language-dropdown-menu" aria-labelledby="language1">
                                ...
                                <a class="dropdown-item" href="#">
                                    <img src="assets/images/uae.png" alt="flag"> العربيّة
                                </a>
                            </div>
                        </li>
                    </ul>
    ...
    <div class="navbar-area">
                        ...
                        <ul class="navbar-nav m-auto">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="#" class="nav-link">Beauty, Toys & More</a>
                                    </li>
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="nav-item">
                                        <a href="#" class="nav-link">Hot Promotions</a>
                                    </li>

                                    <li class="nav-item">
                                        <a href="#" class="nav-link">Consumer Electronic</a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="#" class="nav-link">
                                            ...
                                            <li class="nav-item">
                                                <a href="#" class="nav-link">Jewllery & Watches</a>
                                            </li>
                                        
                                    </li>

                                    <li class="nav-item">
                                        <a href="#" class="nav-link">Computer & Technology</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#" class="nav-link">Babies & Moms</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#" class="nav-link">Sports</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#" class="nav-link">Phones & Accessories</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#" class="nav-link">Books</a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="#" class="nav-link">Cars & Motocycles</a>
                                    </li>
                                </ul>
                            </li>
        ...
        <!-- Start Shop Area -->
        <h1 class="text-center"> Books</h1><br>
...
$sql = "SELECT * FROM notifications WHERE read_status = 0 ORDER BY created_at DESC";
...
// Retrieve the unread notifications ordered by creation time
$sql = "SELECT * FROM notifications WHERE read_status = 0 ORDER BY created_at DESC";
$result = $conn->query($sql);

// Display the notifications as JavaScript popups
while ($row = $result->fetch_assoc()) {
    echo "<script>alert('" . $row['message'] . "');</script>";

    // Mark the notification as read
    $notificationId = $row['id'];
    $updateSql = "UPDATE notifications SET read_status = 1 WHERE id = $notificationId";
