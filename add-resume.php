...
<!-- Mirrored from templates.envytheme.com/eeza/default/add-resume.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 15 Sep 2022 09:05:55 GMT -->
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                                ...
                                <ul class="navbar-nav m-auto">
                                    ...
                                    <li class="nav-item">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="nav-item">
                                                <a href="add-resume.php" class="nav-link active">Add Resume</a>
                                            </li>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="single-footer-widget">
                            <div class="widget-logo">
                                <a href="index.php"><img src="assets/images/logo-2.png" alt="image"></a>
                            </div>
                        ...
                        <div class="single-footer-widget">
                            ...
                            <ul class="widget-info">
                                ...
                                <li>
                                    ...
                                    <a href="https://templates.envytheme.com/cdn-cgi/l/email-protection#cca4a9a0a0a38ca9a9b6ade2afa3a1"><span class="__cf_email__" data-cfemail="2048454c4c4f6045455a410e434f4d">[email&#160;protected]</span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
